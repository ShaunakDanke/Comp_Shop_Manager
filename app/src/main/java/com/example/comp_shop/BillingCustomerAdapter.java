...
public class BillingCustomerAdapter extends RecyclerView.Adapter<BillingCustomerAdapter.CustomerViewHolder> {

    private List<Customer> billingcustomerList;
    ...
    public BillingCustomerAdapter(List<Customer> customerList, OnCustomerSelectedListener listener) {
        this.billingcustomerList = customerList;
    ...
    public CustomerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.customer_billing_item, parent, false);
        return new CustomerViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerViewHolder holder, int position) {
        Customer customer = billingcustomerList.get(position);
    ...
    public int getItemCount() {
        return billingcustomerList.size();
    }
